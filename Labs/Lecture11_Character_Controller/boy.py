...
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, \
    SHIFT_UP, SHIFT_DOWN, DASH_TIMER, DEBUG_KEY = range(9)

event_name = ['RIGHT_DOWN', 'LEFT_DOWN', 'RIGHT_UP', 'LEFT_UP', 'SLEEP_TIMER', \
    'SHIFT_UP', 'SHIFT_DOWN', 'DASH_TIMER']
key_event_table = {
...
table = {
    "SLEEP" : {"HIT": "WAKE", "TIMER10": "SLEEP"},
    "WAKE": {"TIMER10": "SLEEP", "HIT": "WAKE"}
}
...
next_state_table = {
    ...
    IdleState: {RIGHT_UP: RunState, LEFT_UP: RunState,
                ...
                SLEEP_TIMER: SleepState, SHIFT_DOWN: IdleState, SHIFT_UP: IdleState,},
    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState,
               LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState,
               SHIFT_DOWN: DashState, SHIFT_UP: RunState},
    SleepState: {LEFT_DOWN: RunState, RIGHT_DOWN: RunState, SHIFT_DOWN: SleepState, SHIFT_UP: SleepState,
